...
import com.project.nexstay.entity.HotelMinPrice;
...
@Transactional
public class PricingUpdateStrategy {

    //Scheduler to update the inventory and hotel minprice table every hour
